...
| [`PROMPT_V3_0_0_RECOVERED_SOURCE_INGEST.md`](./PROMPT_V3_0_0_RECOVERED_SOURCE_INGEST.md) | 📋 **Proposed — ready to run** | Hand-off brief for ingesting the **recovered WordPress export** (`wayback/centraltexasmuralsbyroryskagen-20231217234521/`) into the v3 program: re-derive the counts, classify NEW/EXISTS/COLLISION, and **diff the recovered corpus against the `centraltexasmurals.com-v1` extraction** | Written 2026-09-15, after 3.A/3.B completed. The recovered archive is a **full WP Migrate export of the live site, not a scrape** — 63 authored mural posts + ~350 originals vs the scrape's 61 pages with 7 images, so it **supersedes** that source. Proposes a new **§3.D**; ⚠️ §3.C is the ADR 0001 Phase B *exit criteria*, not a free slot. ⚠️ Read `ROADMAP_V3.md` as `git show 045788a:plan/ROADMAP_V3.md` until PR #23 merges |
